...
# --- CONFIGURAÇÃO ---
# Certifica-te que tens o ficheiro SLTrack.ini com o teu user e pass
...
# --- EXECUÇÃO ---
combined_df = get_spacetrack_data()
...
if combined_df is not None:
    ...
    df_final.to_csv('../DATASET_SATTELITE/spacetrack_last_data_tle.csv', index=False)
